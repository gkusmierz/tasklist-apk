...
class Task : public QObject
{
    ...
    Q_PROPERTY(DueType dueType READ dueType WRITE setDueType NOTIFY dueTypeChanged)
    Q_PROPERTY(Reminder reminder READ reminder WRITE setReminder NOTIFY reminderChanged)
    Q_PROPERTY(ReminderType reminderType READ reminderType WRITE setReminderType
               NOTIFY reminderTypeChanged)
...
public:
    ...
    Q_INVOKABLE
    static long long dateToMillisec(const QString &date) {
    ...
    DueType dueType() const;
    void setDueType(DueType dueType);
...
Q_SIGNALS:
    ...
    void dueTypeChanged(DueType dueType);
